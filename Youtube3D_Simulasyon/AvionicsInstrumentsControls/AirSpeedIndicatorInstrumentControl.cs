...
namespace AvionicsInstrumentControlDemo
{
    class AirSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(Youtube3D_Simulasyon.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.AirSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(Youtube3D_Simulasyon.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.AirSpeedNeedle);
